...
class JSONSaver(Saver):
    ...
    def add_vacancy(self, vacancy: "Vacancy") -> None:
        ...
        if not any(v["id"] == vacancy.id for v in data):
            ...
            self.filename.write_text(json.dumps(data, ensure_ascii=False, indent=4), encoding="utf-8")
    ...
    def delete_vacancy(self, vacancy: "Vacancy") -> None:
        ...
        try:
            ...
            updated_vacancies = [v for v in vacancies if v["id"] != vacancy.id]
            ...
            with open(self.filename, "w", encoding="utf-8") as file:
                json.dump(updated_vacancies, file, ensure_ascii=False, indent=2)
